...
library(data.table)
library(tidyverse)
varInfo <- fread(paste0("/Users/kimjoj/Documents/shiny_apps/variant_browser/dataprocessing/exomedata-200302/chr", i, ".tsv"), drop = c('non_topmed_AF_popmax',	'non_neuro_AF_popmax',	'non_cancer_AF_popmax'), nrows = 1)
varInfo <- varInfo[0]
